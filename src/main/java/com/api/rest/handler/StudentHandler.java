...
public class StudentHandler {
    ...
    public Mono<ServerResponse> findAllAsc(ServerRequest request) {
        return ServerResponse.ok()
                .contentType(MediaType.APPLICATION_JSON)
                .body(service.findAllOrderByAgeAsc().map(this::convertToDto), StudentDTO.class);
    }

    public Mono<ServerResponse> findAllDesc(ServerRequest request) {
        return ServerResponse.ok()
                .contentType(MediaType.APPLICATION_JSON)
                .body(service.findAllOrderByAgeDesc().map(this::convertToDto), StudentDTO.class);
    }
