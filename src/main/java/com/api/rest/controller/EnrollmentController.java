...
public class EnrollmentController {
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    @PutMapping("/{id}")
    public Mono<ResponseEntity<EnrollmentDTO>> update(@Valid @PathVariable String id, @RequestBody EnrollmentDTO dto) {
    ...
    private EnrollmentDTO convertToDto(Enrollment invoice) {
        return modelMapper.map(invoice, EnrollmentDTO.class);
    }
